...
export function FieldLayout({ children }: FieldLayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Time', href: '/field/time', icon: Clock },
    { name: 'Mileage', href: '/field/mileage', icon: Car },
    { name: 'Notes', href: '/field/notes', icon: FileText },
  ]
    ...
    <div className="min-h-screen bg-base flex">
      ...
      <aside className="w-64 bg-base border-r border-accent/20 flex flex-col">
        <div className="p-6 border-b border-accent/20">
          <h1 className="text-xl font-bold text-foreground">Field Portal</h1>
        </div>
